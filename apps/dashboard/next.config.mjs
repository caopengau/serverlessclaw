...
const nextConfig = {
  ...
  outputFileTracingExcludes: {
    '**': [
      ...
      'node_modules/eslint',
      // AI-generated report directories (can be 1GB+, never needed at runtime)
      '.aiready',
      '.aiready/**',
      '**/.aiready',
      '**/.aiready/**',
      ...
      '**/__mocks__',
      '**/__mocks__/**',
      // Build caches and dev-only dirs
      '**/.next/cache',
      '**/.next/cache/**',
      '**/.next/dev',
      '**/.next/dev/**',
      ...
      '**/node_modules/.cache',
      '**/node_modules/.cache/**',
      // Non-web packages that should not be bundled into Next.js Lambda
      '**/apps/cli',
      '**/apps/cli/**',
      // Infra package is SST-only, not needed in Next.js runtime
      '**/packages/infra',
      '**/packages/infra/**',
    ],
  },
