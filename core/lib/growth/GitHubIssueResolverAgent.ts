...
export class GitHubIssueResolverAgent {
   ...
   */
  public async resolve(issue: GitHubIssue, workingDir: string): Promise<ResolutionResult> {
  ...
  private async executeSubtreeSync(issue: GitHubIssue, workingDir: string): Promise<ResolutionResult> {
  ...
  private async applyContributionPattern(issue: GitHubIssue, workingDir: string): Promise<ResolutionResult> {
  ...
  private async applyAgenticPatch(issue: GitHubIssue, workingDir: string): Promise<ResolutionResult> {
