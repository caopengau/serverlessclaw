...
| **7** | The Metabolism | `core/lib/maintenance/metabolism.ts`            | 5           | 2026-04-29   | Low        |
...
| **C**       | Identity Journey  | Brain → Spine → Shield | 6           | 2026-04-27  |
| **D**       | Trust Loop        | Eye → Scales → Spine   | 6           | 2026-04-27  |
