...
3. **Audit the Negative Space**: Look for what is *missing* (e.g., a missing error path in a new feature, missing telemetry in a background task, or missing multi-tenant scoping in a shared utility).
