...
- **Geometry Locking**: Buttons and controls use fixed minimum widths (`min-w-[110px]`) and transparent borders to prevent "jiggling" or 1px shifts when toggling the Mission Control or Intelligence modes.
