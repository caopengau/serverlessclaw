      ...
      <header className="flex justify-between items-end border-b border-white/5 pb-6">
        ...
        <div className="flex gap-4">
          <div className="glass-card px-4 py-2 text-[12px]">
            <div className="text-white/30 mb-1">ACTIVE_LOCKS</div>
      ...
      <section className="space-y-6">
        ...
        <div className="grid gap-4">
          {locks.length > 0 ? (
              ...
              >
                <div className="flex gap-6 items-center">
                    <div className={`w-10 h-10 rounded flex items-center justify-center ${
                        lock.isExpired ? 'bg-white/5 text-white/20' : 'bg-orange-500/10 text-orange-500'
                    }`}>
                        <Lock size={20} />
                    </div>
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            {lock.isExpired && (
                                <span className="text-[9px] px-1.5 py-0.5 rounded border border-white/10 text-white/30 font-bold uppercase">Expired</span>
                            )}
                        </div>
            ...
            <div className="h-48 flex flex-col items-center justify-center text-white/20 border border-dashed border-white/10 rounded-lg">
