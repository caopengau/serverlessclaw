        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <Typography variant="caption" color="muted" className="leading-relaxed block">
              Identify cognitive drift and generate prompt remediation based on real-world failure
              patterns.
            </Typography>
          </div>
        </div>
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="p-4 bg-black/60 rounded border border-white/10 space-y-3">
              <div className="flex items-center justify-between">
                <Badge
                  variant="outline"
                  className="border-cyber-blue/40 text-cyber-blue text-[8px] uppercase tracking-widest"
                >
                  Analysis Result
                </Badge>
                <div className="flex items-center gap-1.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-cyber-green animate-pulse" />
                  <Typography variant="mono" className="text-[9px] text-cyber-green font-bold">
